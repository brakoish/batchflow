...
export default async function TeamsPage() {
  ...
  return <AppShell session={session}><main className="mx-auto max-w-2xl px-4 py-5 pb-24"><h1 className="text-xl font-bold text-foreground">Employee Teams</h1><p className="mt-1 text-sm text-muted-foreground">Save crews once for batch assignments and accounting filters.</p><TeamManager initialTeams={JSON.parse(JSON.stringify(teams))} workers={workers} /></main></AppShell>
}
